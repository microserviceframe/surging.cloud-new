...
using Surging.Cloud.Consul.Internal;
using Surging.Cloud.Consul.Internal.Cluster.HealthChecks;
using Surging.Cloud.Consul.Internal.Cluster.HealthChecks.Implementation;
using Surging.Cloud.Consul.Internal.Cluster.Implementation.Selectors;
using Surging.Cloud.Consul.Internal.Cluster.Implementation.Selectors.Implementation;
using Surging.Cloud.Consul.Internal.Implementation;
using Surging.Cloud.Consul.WatcherProvider;
using Surging.Cloud.Consul.WatcherProvider.Implementation;
