...
namespace Surging.Cloud.CPlatform.Serialization.Implementation
{
    ...
    public class StringByteArraySerializer : ISerializer<byte[]>
    {
        ...
        {
            return Encoding.UTF8.GetBytes(_serializer.Serialize(instance,camelCase,indented));
        }
        ...
        {
            return _serializer.Deserialize(Encoding.UTF8.GetString(content), type, camelCase, indented);
        }
